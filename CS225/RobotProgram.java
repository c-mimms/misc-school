...
public class RobotProgram extends Application
{
	...
	public void start(Stage stage) throws Exception
	{
		...
		test.layoutXProperty().bind(top.layoutXProperty());
		test.layoutYProperty().bind(top.layoutYProperty());
		test.heightProperty().bind(top.heightProperty());
		test.widthProperty().bind(top.widthProperty());
